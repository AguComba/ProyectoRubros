...
namespace ProyectoPruebas.Data.Migrations
{
    ...
    [Migration("20220512182952_SubRubroDescripcionEnArticuloMostrar")]
    partial class SubRubroDescripcionEnArticuloMostrar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoPruebas.Models.Articulo", b =>
                {
            ...
            modelBuilder.Entity("ProyectoPruebas.Models.Rubro", b =>
                {
            ...
            modelBuilder.Entity("ProyectoPruebas.Models.SubRubro", b =>
                {
                    b.Property<int>("SubRubroID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoPruebas.Models.Articulo", b =>
                {
                    b.HasOne("ProyectoPruebas.Models.SubRubro", "SubRubro")
                        .WithMany("Articulos")
            ...
            modelBuilder.Entity("ProyectoPruebas.Models.SubRubro", b =>
                {
                    b.HasOne("ProyectoPruebas.Models.Rubro", "Rubro")
                        .WithMany("SubRubros")
